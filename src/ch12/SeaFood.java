...
public class SeaFood {
	...
	public static void main(String[] args) {
		try {
			...
			Gson gson = new Gson();
			SeaFoodInfo seaFoodInfo = gson.fromJson(sb.toString(), SeaFoodInfo.class);
			ArrayList<SeaFoodInfo> seaFoodInfos = new ArrayList<>();
			//System.out.println(seaFoodInfos.add(seaFoodInfo));
			//seaFoodInfos.add(seaFoodInfo);
